...
class RiskAnalysisOutput(BaseModel):
    ...
    downside_risks: list[str] = Field(description="List of specific downside risks (e.g., 'Regulatory probe independent of earnings').")
    bear_case_probability: int = Field(description="Probability (0-100%) of the bear case materializing.")
    worst_case_scenario: str = Field(description="Description of the worst-case scenario (e.g., 'Stock drops 40% if merger fails').")
    macro_threats: list[str] = Field(description="Macroeconomic threats (e.g., 'Interest rate hikes', 'Sector rot').")
    fraud_risk: str = Field(description="Assessment of accounting irregularities or management trust issues.")
